...
public class AssessmentsController {
        ...
        public ResponseEntity<AssessmentResource> createAssessment(@RequestBody CreateAssessmentResource resource) {
                var createAssessmentCommand = CreateAssessmentCommandFromResourceAssembler
        ...
        public ResponseEntity<AssessmentResource> updateAssessment(
                ...
                var updateAssessmentCommand = UpdateAssessmentCommandFromResourceAssembler
                                .toCommandFromResource(assessmentId, resource);
                var updatedAssessment = assessmentCommandService.handle(updateAssessmentCommand);
                if (updatedAssessment.isEmpty())
                        return ResponseEntity.notFound().build();
                var updatedAssessmentEntity = updatedAssessment.get();
                var updatedAssessmentResource = AssessmentResourceFromEntityAssembler
                                .toResourceFromEntity(updatedAssessmentEntity);
        ...
        public ResponseEntity<Void> deleteAssessment(@PathVariable Long assessmentId) {
                var deleteAssessmentCommand = new DeleteAssessmentCommand(assessmentId);
                assessmentCommandService.handle(deleteAssessmentCommand);
